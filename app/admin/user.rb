ActiveAdmin.register User do
  ...
  show do
    ...
    panel "Premium Community Demo Plan Usage" do 
      table_for user.entity.premium_community_transcripts_usage_year do |tbl|
        tbl.column('Date') {|mu| mu[:period]}
        tbl.column('Demo Usage Minutes') {|mu| mu[:total]}
      end
    end
