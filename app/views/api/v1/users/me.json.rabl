...
if current_user
  ...
  node(:organization) {
    {
      ...
      community_plan_used: current_user.organization.premium_community_transcripts_all_time,
      community_plan_used_this_month: current_user.organization.premium_community_transcripts_usage
  ...
  if !current_user.extras['ignore_limit'] == true
  ...
  node(:community_plan_used) { current_user.premium_community_transcripts_all_time }
  node(:community_plan_used_this_month) {current_user.premium_community_transcripts_usage} 
